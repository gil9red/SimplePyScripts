...
if __name__ == '__main__':
    ...
    number_all_ep_s1, _, number_filler_ep_s1, precent_filler_s1 = calc_statistic(ep_chapters_s1)
    print(f'Season 1.\n'
          f'    Total: {number_all_ep_s1}, fillers: {number_filler_ep_s1} ({precent_filler_s1:.1f}%)\n')

    ep_chapters_s2 = get_ep_chapters_s2()
    number_all_ep_s2, _, number_filler_ep_s2, precent_filler_s2 = calc_statistic(ep_chapters_s2)
    print(f'Season 2.\n'
