...
if __name__ == '__main__':
    ...
    text = get_valid_filename("$@.'CPCSEA'2014-1203-RSDp. Performance Evaluation Form' Non-Executive. (Package'2014-1203-RSD. IPetrash'). v[2-06]r.docx")
    print(text)
    assert text == '.CPCSEA2014-1203-RSDp._Performance_Evaluation_Form_Non-Executive._Package2014-1203-RSD._IPetrash._v2-06r.docx'
