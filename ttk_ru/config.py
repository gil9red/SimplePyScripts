...
try:
    LOGIN_PASSWORD = (
        ...
        or LOGIN_PASSWORD_FILE_NAME.read_text("utf-8").strip()
    )
    ...
    print(
        f"Нужно в {LOGIN_PASSWORD_FILE_NAME.name} или в переменную окружения LOGIN_PASSWORD добавить логин и пароль"
    )
