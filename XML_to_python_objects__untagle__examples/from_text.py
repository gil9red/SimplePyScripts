...
''')
print(obj.root.child)                 # [Element(name = child, attributes = {'name': 'child1'}, cdata = ), ...
...
''')
print(obj.root.child)          # Element <child> with attributes {'name': 'child2'}, children [] and cdata Text
