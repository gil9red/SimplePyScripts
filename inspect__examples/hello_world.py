...
print('Current code context:', inspect.getframeinfo(inspect.currentframe()).code_context)
print()

print('Current function:', inspect.getframeinfo(inspect.currentframe()).function)
print('Current function:', (lambda: inspect.getframeinfo(inspect.currentframe()).function)())
