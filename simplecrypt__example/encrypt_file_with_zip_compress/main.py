...
if __name__ == '__main__':
    ...
    print('Encrypt zip len: {}, digest: {}'.format(len(cipher_zip_data), cipher_zip_digest))
    ...
    print('Decrypt zip len: {}, digest: {}'.format(len(decrypt_zip_data), decrypt_zip_data_digest))
    ...
    print('Decompress message len: {}, digest: {}'.format(len(decompress_message), decompress_message_digest))
    ...
    print()
    print('Digest for zip is equal: {}'.format(zip_data_digest == decrypt_zip_data_digest))
