...
class BaseServer(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        result = subprocess.check_output(value, encoding='CP866', shell=True, universal_newlines=True)
        self.wfile.write(
            result.encode('utf-8')
        )
...
if __name__ == "__main__":
    ...
    # Start in 2 seconds
    Timer(2, lambda: (
        print(urlopen('http://127.0.0.1:8080/?value=ipconfig').read().decode('utf-8'))
    )).start()
