...
subprocess.call([
    "pyinstaller", '--clean', "--onefile", '_test_file.py'
])
...
subprocess.call([
    sys.executable, 'pyinstxtractor.py', 'dist/_test_file.exe'
])
...
subprocess.call([
    'uncompyle6', '-o', str(source_test_file), '_test_file.exe_extracted/_test_file.pyc'
])
