...
def build_sql_rows_data_table(table_name: str, rows_of_table: [dict]) -> str:
    ...
    Функция по данным о полях сгенерирует запрос для добавления их в таблицу:
        INSERT OR IGNORE INTO BANKS (ADDRESS4,ATTR_GRPS,CAN_CHANGE,CAN_REVOKE,CITY_HEAD,CITY_ID,CITY_LAT,CO_IN_EUR,CO_IN_RUR,CO_IN_USD,CO_OUT_EUR,CO_OUT_RUR,CO_OUT_USD,CONTACT,COUNTRY,DELETED,ERASED,GET_MONEY,ID,IS_KFM,IS_ONLINE,LOGO_ID,NAME,NAME_RUS,PARENT_ID,PP_CODE,REC_CURR,REGION,SCEN_ID,SEND_CURR,UNIQUE_TRN,VERSION) VALUES ('','38434','1','1','"ЗАЧИСЛЕНИЕ НА СЧЕТ"','158633','"BANK DEPOSIT"','-1','-1','-1','1','-1','-1','1','233','0','0','0','1005078','1','0','0','PAYOUT IN "BANK DEPOSIT"','Безадресная выплата в г. "ЗАЧИСЛЕНИЕ НА СЧЕТ"','115734','AKKD','EUR;','233017','0','','0','15');
        INSERT OR IGNORE INTO BANKS (ADDRESS4,ATTR_GRPS,CAN_CHANGE,CAN_REVOKE,CITY_HEAD,CITY_ID,CITY_LAT,CO_IN_EUR,CO_IN_RUR,CO_IN_USD,CO_OUT_EUR,CO_OUT_RUR,CO_OUT_USD,CONTACT,COUNTRY,DELETED,ERASED,GET_MONEY,ID,IS_KFM,IS_ONLINE,LOGO_ID,NAME,NAME_RUS,PARENT_ID,PP_CODE,REC_CURR,REGION,SCEN_ID,SEND_CURR,UNIQUE_TRN,VERSION) VALUES ('','38434','1','1','"ЗАЧИСЛЕНИЕ НА СЧЕТ"','158633','"BANK DEPOSIT"','-1','-1','-1','1','-1','-1','1','233','0','0','0','1005195','1','0','0','PAYOUT IN "BANK DEPOSIT"','Безадресная выплата в г. "ЗАЧИСЛЕНИЕ НА СЧЕТ"','115734','AKLZ','EUR;','233017','0','','0','15');
        INSERT OR IGNORE INTO BANKS (ADDRESS4,ATTR_GRPS,CAN_CHANGE,CAN_REVOKE,CITY_HEAD,CITY_ID,CITY_LAT,CO_IN_EUR,CO_IN_RUR,CO_IN_USD,CO_OUT_EUR,CO_OUT_RUR,CO_OUT_USD,CONTACT,COUNTRY,DELETED,ERASED,GET_MONEY,ID,IS_KFM,IS_ONLINE,LOGO_ID,NAME,NAME_RUS,PARENT_ID,PP_CODE,REC_CURR,REGION,SCEN_ID,SEND_CURR,UNIQUE_TRN,VERSION) VALUES ('','38434','1','1','"ЗАЧИСЛЕНИЕ НА СЧЕТ"','158645','"BANK DEPOSIT"','-1','-1','-1','1','-1','-1','1','440','0','0','0','1005034','1','0','0','PAYOUT IN "BANK DEPOSIT"','Безадресная выплата в г. "ЗАЧИСЛЕНИЕ НА СЧЕТ"','111657','AKIL','EUR;','440072','0','','0','15');
        INSERT OR IGNORE INTO BANKS (ADDRESS4,ATTR_GRPS,CAN_CHANGE,CAN_REVOKE,CITY_HEAD,CITY_ID,CITY_LAT,CO_IN_EUR,CO_IN_RUR,CO_IN_USD,CO_OUT_EUR,CO_OUT_RUR,CO_OUT_USD,CONTACT,COUNTRY,DELETED,ERASED,GET_MONEY,ID,IS_KFM,IS_ONLINE,LOGO_ID,NAME,NAME_RUS,PARENT_ID,PP_CODE,REC_CURR,REGION,SCEN_ID,SEND_CURR,UNIQUE_TRN,VERSION) VALUES ('','38434','1','1','10','151790','10','-1','-1','-1','-1','-1','1','1','51','0','0','0','1004447','1','0','0','PAYOUT IN MIJNAVAN','Безадресная выплата в г. МИДЖНАВАН','106134','AJLU','USD;','51010','0','','0','15');
        INSERT OR IGNORE INTO BANKS (ADDRESS4,ATTR_GRPS,CAN_CHANGE,CAN_REVOKE,CITY_HEAD,CITY_ID,CITY_LAT,CO_IN_EUR,CO_IN_RUR,CO_IN_USD,CO_OUT_EUR,CO_OUT_RUR,CO_OUT_USD,CONTACT,COUNTRY,DELETED,ERASED,GET_MONEY,ID,IS_KFM,IS_ONLINE,LOGO_ID,NAME,NAME_RUS,PARENT_ID,PP_CODE,REC_CURR,REGION,SCEN_ID,SEND_CURR,UNIQUE_TRN,VERSION) VALUES ('','38434','1','1','6','151687','6','-1','-1','-1','1','1','1','1','51','0','0','0','1004427','1','0','0','PAYOUT IN BERDZOR','Безадресная выплата в г. БЕРДЗОР','106134','AJLA','RUR;USD;EUR;','51010','0','','0','15');
