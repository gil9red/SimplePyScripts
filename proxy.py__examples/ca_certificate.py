...
def main():
    # Generate CA key
    os.system(f'python -m proxy.common.pki gen_private_key --private-key-path {CA_KEY_FILE_PATH}')
    os.system(f'python -m proxy.common.pki remove_passphrase --private-key-path {CA_KEY_FILE_PATH}')
    ...
    os.system(f'python -m proxy.common.pki gen_private_key --private-key-path {CA_SIGNING_KEY_FILE_PATH}')
    os.system(f'python -m proxy.common.pki remove_passphrase --private-key-path {CA_SIGNING_KEY_FILE_PATH}')
