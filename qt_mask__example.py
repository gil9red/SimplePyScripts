...
line_edit_pin.textEdited.connect(lambda text: label_pin.setText('PIN: "{}"'.format(text)))

# Payment card numbers can be up to 19 digits
label_pan = QLabel()
line_edit_pan = QLineEdit()
line_edit_pan.setInputMask('9999 9999 9999 0000 000')
line_edit_pan.textEdited.connect(lambda text: label_pan.setText('PAN: "{}"'.format(text)))
