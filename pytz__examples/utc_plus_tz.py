...
print(tz_moscow.fromutc(now))
# 2025-01-01 15:00:00+03:00

print(tz_etc_0300.fromutc(now))
# 2025-01-01 15:00:00+03:00

print(tz_offset_0300.fromutc(tz_offset_0300.localize(now)))
# 2025-01-01 15:00:00+03:00

print(tz_utc.fromutc(tz_utc.localize(now)))
