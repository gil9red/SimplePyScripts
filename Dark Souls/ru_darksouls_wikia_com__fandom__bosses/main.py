...
export_to_json(
    "dumps/ds1/bosses__only_name.json", convert_bosses_to_only_name(bosses_ds1)
)
...
export_to_json(
    "dumps/ds2/bosses__only_name.json", convert_bosses_to_only_name(bosses_ds2)
)
...
export_to_json(
    "dumps/ds3/bosses__only_name.json", convert_bosses_to_only_name(bosses_ds3)
)
...
print(
    "Total boss DS1:",
    connect.execute(
        'SELECT count(*) FROM BOSS WHERE game = "Dark Souls"'
    ).fetchone()[0],
)
print(
    "Total boss DS2:",
    connect.execute(
        'SELECT count(*) FROM BOSS WHERE game = "Dark Souls II"'
    ).fetchone()[0],
)
print(
    "Total boss DS3:",
    connect.execute(
        'SELECT count(*) FROM BOSS WHERE game = "Dark Souls III"'
    ).fetchone()[0],
)
# Total boss: 92
# Total boss DS1: 26
