...
# global_transitions = [('z' + str(i) + 'x', 'z' + str(i) + 'y') for i, (title_from, title_to) in enumerate(global_transitions, 1)]
...
import json
json.dump(miserables, open('miserables.json', 'w', encoding='utf-8'), indent=4, ensure_ascii=False)
