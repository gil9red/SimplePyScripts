...
def get_dataset(global_transitions: List[Tuple[str, str]]) -> str:
    # Список всех узлов графа
    nodes = set()
    for a, b in global_transitions:
        nodes.add(a)
        nodes.add(b)
