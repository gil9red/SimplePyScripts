...
try:
    ...
    try:
        from PyQt4.QtGui import (QImage, QPainter, QApplication, QWidget,
                                 QLabel, QPushButton, QVBoxLayout, QSizePolicy, QPixmap)
        from PyQt4.QtCore import Qt

    except ImportError:
        from PySide.QtGui import (QImage, QPainter, QApplication, QWidget,
                                  QLabel, QPushButton, QVBoxLayout, QSizePolicy, QPixmap)
