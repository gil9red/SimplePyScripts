...
try:
    ...
    progress__text_el = player_progress_el.find_element_by_css_selector('.progress__bar.progress__text')
    ...
    while True:
        ...
        print(f'{track.title}. {progress_left_str} / {progress_right_str} ({progress_left / progress_right:.1%})')
