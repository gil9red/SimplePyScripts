...
def search_video_list(text: str) -> list[str]:
    ...
    while True:
        ...
        if (
            b"Attention Required! | Cloudflare" in content
            or b"Access denied | online.anidub.com used Cloudflare to restrict access"
            in content
        ):
...
if __name__ == "__main__":
    ...
    json.dump(
        items,
        open("video_list.json", "w", encoding="utf-8"),
        ensure_ascii=False,
        indent=4,
    )
