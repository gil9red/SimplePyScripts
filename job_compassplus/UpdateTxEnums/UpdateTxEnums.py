...
# перечислений на C# в соответствии с этими перечислениями в транзаксисе.
...
# Ключом является id перечисления, а значением словарь: ключ - имя константы, значение - комментарий константы.
