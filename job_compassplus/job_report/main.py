...
print()
person = get_person_info(second_name='Петраш', first_name='Илья', report_dict=report_dict)
if person:
    print(f'#{sorted_person_list.index(person) + 1}. {person.full_name} {person.deviation_of_time}')
