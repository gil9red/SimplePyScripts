...
# SOURCE: https://github.com/mozman/svgwrite/blob/master/examples/ltattrie/circle_blur.py
...
def create_svg(name):
    ...
    defs_g_text.add(
        dwg.text("SVGWRITE", insert=(0, 0), font_family="serif", font_size=FONT_SIZE)
    )
