...
session.headers[
    "Authorization"
] = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJydS5nb3MtZGV2LmF1dGgiLCJpYXQiOjE2MDIxNzAwNzIsImV4cCI6MTAwMDE2MDIxNzAwNzEsInN1YiI6ImYxODIyMTMwLTI2OTctNDk5Ni1hNDExLWI4NzQwMzZlYjYxMyJ9.HmQJ5vL6fSzejEbEMzihDLDiwv86545JGuB3_MRlYe8"
...
def get_first_house_id(street_id: int, house_number: str) -> int:
    rs = send_data(
        ...
        {
            "filter": {
                "streetId": {"$eq": street_id},
                "houseNumber": {"$like": f"{house_number}%"},
            },
            "limit": 0,
            "offset": 0,
